module Learning
  ...
  class Config
attr_accessor :slow_ms, :fast_ms, :mastery_deltas, :frequency_prior_decay,
              :priority_weights, :new_kanji_per_session, :session_review_target,
              :known_threshold, :recent_exposure_window, :diagnostic_bands,
    ...
    def slow?(response_time_ms)
      response_time_ms && response_time_ms > slow_ms
    end
